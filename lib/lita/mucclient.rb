# xmpp4r has been abandoned. A commit that allows you to suppress MUC history
# is on master, but there has been no gem release. Rather than vendor the entire
# repo, just monkey patch the #join method with the updated version we need.
module Jabber
  module MUC
    class MUCClient
